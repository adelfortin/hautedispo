...
if nmcli connection add type ethernet con-name réseau84 ifname $INTERFACE_1 ipv4.adresses $IPV4_1 ipv4.gateway $PASSERELLE_1 ipv4.dns "$DNS_1 $DNS_2" ipv4.method manual ; then
